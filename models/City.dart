...
class City {
  String name = "";
  List<Stop?> stops =
      List<Stop?>.filled(9, null); // inizialmente vuoto, max length 9
  double? min_steps;
...
City Paris = City(
    ...
    List<Stop>.from([
      ...
      Stop.create(
          "Versailles",
          "https://www.cronachedispogliatoio.it/wp-content/uploads/2022/01/versailles-scaled.jpg",
...
City London = City(
    ...
    List<Stop>.from([
      Stop.create(
          "London eye",
          "https://cdn.thecrazytourist.com/wp-content/uploads/2018/08/ccimage-shutterstock_433759954.jpg",
      ...
      Stop.create(
          "National Gallery",
          "https://www.planetware.com/photos-large/ENG/england-london-national-gallery-3.jpg",
